        ...
        <div class="card shadow rounded border-0">
            <div class="card-body">
                 <div class="add_case_area">
                    <form id="dataSubmit-form" action="{{ route('stafflist.update', $stafflist->id) }}" method="POST"
                        ...
                        <div class="row g-4">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="text" name="name" id="name" value="{{ $stafflist->name }}"
                                        placeholder="Name">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="text" name="number" id="number" value="{{ $stafflist->number }}"
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="email" name="email" id="email" value="{{ $stafflist->email }}"
                                        placeholder="Email">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="text" name="whatsapp" id="whatsapp" value="{{ $stafflist->whatsapp }}"
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="text" name="qualification" id="qualification"
                                        value="{{ $stafflist->qualification }}" placeholder="qualification">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="text" name="possition" id="possition" value="{{ $stafflist->possition }}"
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <div class="form_group">
                                    <input type="text" name="address" id="address" value="{{ $stafflist->address }}"
                                        placeholder="Address">
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                                <img style="height: 100px; width:100px; border-radius:7px"
                                    src="{{ asset('images/' . $stafflist->image) }}" alt="">
                                <div class="form_group">
                                    <input type="file" name="image" value="{{ $stafflist->image }}" id="image"
                                        placeholder="image">
