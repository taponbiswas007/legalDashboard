        ...
        <div class="card shadow rounded border-0">
            <div class="card-body">
                <div class="add_case_area">
                    <form id="jobForm" action="{{ route('jobs.update', $job->id) }}" method="POST"
                        ...
                        <div class="row g-4">
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form_group">
                                    <input type="text" class="@error('title') is-invalid @enderror" id="title"
                                        name="title" value="{{ old('title', $job->title) }}" placeholder="Job Title"
                                        required>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form_group">
                                    <input type="date" class="@error('deadline') is-invalid @enderror" id="deadline"
                                        name="deadline" value="{{ old('deadline', $job->deadline->format('Y-m-d')) }}"
                                        required>
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6">
                                <div class="form_group">
                                    ...
                                    <small class="form-text text-muted d-block mt-1">Upload a new file to replace. Max:
                                        10MB</small>
                                </div>
                                @if ($job->pdf_file)
                                    <p class="m-2 text-success">
                                        <i class="fa-solid fa-file-pdf"></i> Current:
                                        <strong>{{ $job->pdf_file }}</strong>
                            ...
                            <div class="col-12">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="is_published"
                                        name="is_published" value="1" {{ $job->is_published ? 'checked' : '' }}>
