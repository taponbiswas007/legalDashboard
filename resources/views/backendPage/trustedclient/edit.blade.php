<x-app-layout>
    <div class="py-4 px-1 body_area">
        ...
        <div class="add_case_area">
            <form id="dataSubmit-form" action="{{ route('trustedclient.update', $trustedclient->id) }}" method="POST"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        ...
                        <div class="form_group">
                            <input type="file" name="image" value="{{ $trustedclient->image }}" id="image"
                                placeholder="image">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="">
                            ...
                            <input class="" type="checkbox" name="status"
                                {{ $trustedclient->status == 1 ? 'checked' : '' }}>
