...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/admin/user-approval', [\App\Http\Controllers\SuperAdminController::class, 'userApprovalList'])->name('admin.users.approval');
    Route::post('/admin/user-approve/{id}', [\App\Http\Controllers\SuperAdminController::class, 'approveUser'])->name('admin.users.approve');
});
...
// Admin Job Management Routes (Backend - requires auth)
